...
from models import GPT2LMHeadModel_nipq
...
MODEL_NAME = f'GPT-97M-nipq-{Weight_bit}{Activation_bit}-epoch{NUM_EPOCHS}-warmup{WARMUP_STEPS}-lr{LR}-bs{BATCH_SIZE}-temp{TEMPERATURE}-alpha{ALPHA}'
...
# student = GPT2LMHeadModel_nipq(config)
student = GPT2LMHeadModel_nipq.from_pretrained(student_dir)
