...
class ActFn(Function):
    # xuan: todo: change 'k=8' for ablation; here is the activation bit width
    @staticmethod
...
class Linear(nn.Linear):
    # xuan: todo: change 'bitwidth=4' for ablation
    def __init__(self, in_features, out_features, bias=True, bitwidth=4):
    ...
    def forward(self, x):
        ...
        try:
            ...
            y = F.linear(x, torch.transpose(vhat, 0, 1), self.bias)   # for gpt training
        return y
