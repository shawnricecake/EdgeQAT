...
from models import LlamaForCausalLM_qat
...
MODEL_NAME = f'Llama-58M-qat-{Weight_bit}{Activation_bit}-epoch{NUM_EPOCHS}-warmup{WARMUP_STEPS}-lr{LR}-bs{BATCH_SIZE}-temp{TEMPERATURE}-alpha{ALPHA}'
...
# student = LlamaForCausalLM_qat(config)
student = LlamaForCausalLM_qat.from_pretrained(student_dir)
