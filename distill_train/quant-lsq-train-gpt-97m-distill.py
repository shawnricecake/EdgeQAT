...
from models import GPT2LMHeadModel_lsq
...
MODEL_NAME = f'GPT-97M-lsq-{Weight_bit}{Activation_bit}-epoch{NUM_EPOCHS}-warmup{WARMUP_STEPS}-lr{LR}-bs{BATCH_SIZE}-temp{TEMPERATURE}-alpha{ALPHA}'
...
# student = GPT2LMHeadModel_lsq(config)
student = GPT2LMHeadModel_lsq.from_pretrained(student_dir)
